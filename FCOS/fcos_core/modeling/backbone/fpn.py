...
# [GCC 10.2.1 20210110]
# Embedded file name: /home/cagatay/PycharmProjects/Expiry/FCOS/fcos_core/modeling/backbone/fpn.py
        ...
        for feature, inner_block, layer_block in zip(x[:-1][::-1], self.inner_blocks[:-1][::-1], self.layer_blocks[:-1][::-1]):
            if not inner_block:
                ...
                inner_top_down = F.interpolate(last_inner,
                  size=(int(inner_lateral.shape[(-2)]), int(inner_lateral.shape[(-1)])), mode='nearest')
...
class LastLevelP6P7(nn.Module):
    ...
    def forward(self, c5, p5):
        ...
        return [p6, p7]
# okay decompiling ./fcos_core/modeling/backbone/fpn.pyc
