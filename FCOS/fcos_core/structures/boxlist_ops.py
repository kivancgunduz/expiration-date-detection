...
# [GCC 10.2.1 20210110]
# Embedded file name: /home/cagatay/PycharmProjects/Expiry/FCOS/fcos_core/structures/boxlist_ops.py
# Compiled at: 2021-12-16 06:36:40
# Size of source mod 2**32: 4568 bytes
import torch
from .bounding_box import BoxList
from FCOS.fcos_core.layers import nms as _box_nms
from FCOS.fcos_core.layers import ml_nms as _box_ml_nms
...
def cat_boxlist(bboxes):
    ...
    if not isinstance(bboxes, (list, tuple)):
        ...
        if not all(isinstance(bbox, BoxList) for bbox in bboxes):
            raise AssertionError
        else:
            size = bboxes[0].size
    ...
    return cat_boxes
# okay decompiling ./fcos_core/structures/boxlist_ops.pyc
