...
# [GCC 10.2.1 20210110]
# Embedded file name: /home/cagatay/PycharmProjects/Expiry/DAN/Networks/resnet.py
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, strides, compress_layer=True):
        ...
        if compress_layer:
            self.layer6 = nn.Sequential(nn.Conv2d(512, 256, kernel_size=(3, 1), padding=(0,
                                                                                         0), stride=(1,
                                                                                                     1)), nn.BatchNorm2d(256), nn.ReLU(inplace=True))
...
def resnet45(strides, compress_layer):
    ...
    return model
# okay decompiling ./Networks/resnet.pyc
